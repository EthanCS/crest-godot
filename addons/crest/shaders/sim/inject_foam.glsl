// Injects foam inputs into the foam cascade. Ports Crest's FoamAddFromTex
// (additive texture) and adds an analytic sphere patch variant.
// In-place read-modify-write; one dispatch per input.
...
layout(r16f, set = 0, binding = 2) uniform image2DArray foam_target;
